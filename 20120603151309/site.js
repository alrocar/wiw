...
window.onload = function() {
  var gj = {
    ...
    "features": [
      ...
      { "type": "Feature",
        ...
        "properties": {
          "text":  "Portland is <a href='http://www.portlandblog.com/bridges'>known for its bridges</a> and the Hawthorne Bridge is the nicest walk or bike ride of them all."
        }
      },
      { "type": "Feature",
        "geometry": { "type": "Point",
  ...
  osm = new modLayer(new MM.Template('http://a.tile.openstreetmap.org/{Z}/{X}/{Y}.png?cors=true'), greenFilter);
  ...
  map.zoom(15).center({ lat: 45.5345, lon: -122.6720 });

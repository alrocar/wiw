//game model for the world capitals game
WW.gcapitals = function(geoJSON) {
	this.geoJSON = geoJSON;
	this._buildData();
}

WW.gcapitals.prototype = {
	...
	_buildData: function() {
		...
		var props;
  		...
  		for (var i = 0, len = datos.features.length; i < len; i++) {
			...
			city = new WW.Question(feat.geometry.coordinates[0], feat.geometry.coordinates[1], props["CAPITAL"], props["CAP_POP"]);
			cities.push(city);
  		}

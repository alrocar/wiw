;(function(context, MM) {
    ...
    easey_handlers.TouchHandler = function() {
        ...
        handler.init = function(x) {
            ...
            map.parent.addEventListener("touchmove", preventBehavior, false);
            map.parent.addEventListener("touchstart", preventBehavior, false);
            map.parent.addEventListener("touchend", preventBehavior, false);
            map.parent.addEventListener("click", preventBehavior, false);
            map.parent.addEventListener("dblclick", preventBehavior, false);

...
function vignette(data) {
    new JSManipulate.vignette.filter({height: 256, width: 256, data: data}, {range: 1, amount: 0.9}); 
  }
function solarize(data) {
    new JSManipulate.solarize.filter({height: 256, width: 256, data: data}, {range: 1, amount: 2}); 
  }

  function saturation(data) {
    new JSManipulate.saturation.filter({height: 256, width: 256, data: data}, {range: 1, amount: 2}); 
  }

function sepia(data) {
     new JSManipulate.sepia.filter({height: 256, width: 256, data: data}, {range: 1, amount: 10});     
    // solarize(data);
    // invert(data);    
    //greenFilter(data);
  }
  ...
  function oil(data) {
    new JSManipulate.oil.filter({height: 256, width: 256, data: data}, {range: 1, amount: 2}); 
  }

  function hue(data) {
    new JSManipulate.hue.filter({height: 256, width: 256, data: data}, {range: 1, amount: 0.66}); 
  }

function opacity(data) {
    new JSManipulate.opacity.filter({height: 256, width: 256, data: data}, {range: 1, amount: 0.5}); 
  }

function bright(data) {
    new JSManipulate.brightness.filter({height: 256, width: 256, data: data}, {range: 1, amount: -0.5}); 
  }

function bump(data) {
    new JSManipulate.bump.filter({height: 256, width: 256, data: data}, {range: 1, amount: -0.5}); 
  }

function contrast(data) {
    new JSManipulate.contrast.filter({height: 256, width: 256, data: data}, {range: 1, amount: 1.5}); 
  }

function dither(data) {
    new JSManipulate.dither.filter({height: 256, width: 256, data: data}, {range: 1, levels: 4, color: false}); 
  }

function edge(data) {
    new JSManipulate.edge.filter({height: 256, width: 256, data: data}, {range: 1, levels: 4, color: false}); 
  }

function invert(data) {
    new JSManipulate.invert.filter({height: 256, width: 256, data: data}, {range: 1, levels: 4, color: false}); 
  }

function pixelation(data) {
    new JSManipulate.pixelate.filter({height: 256, width: 256, data: data}, {range: 1, size: 3, color: false}); 
  }

  function blur(data){
    var input = {width :256, height: 256, data: data};
    var values = {amount: 2};
